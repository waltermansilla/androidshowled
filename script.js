...
//Eventos de clicks
btnHamburgerInicio.addEventListener("click", () => {
    irASeccion(sectionInicio);
});
btnHamburgerShows.addEventListener("click", () => {
    irASeccion(sectionShows);
});
btnHamburgerTestimonios.addEventListener("click", () => {
    irASeccion(sectionTestimonios);
});
btnHamburgerEmprende.addEventListener("click", () => {
    irASeccion(sectionEmprende);
});

btnHamburgerCotiza.addEventListener("click", () => {
    irASeccion(sectionCotiza);
});
...
document
    .querySelector("#formEmprender button")
    .addEventListener("click", function () {
        ...
        // Idea
        const idea = document
            .getElementById("presupuesto__textarea")
            .value.trim();
